  ...
  registrar(){
    ...
    switch (this.counter) {
      case 0:
        ...
        this.pacserv.registrardata1(this.paciente,this.atencion, this.idasignacion, this.proximafecha,this.hora.substr(11,5)).subscribe(data=>{
          console.log(data);
      ...
      this.pacserv.registrardata2(this.atencion, this.idasignacion, this.proximafecha,this.hora.substr(11,5)).subscribe(data=>{
        console.log(data);
        this.loading.dismiss();
        this.mdoalctr.dismiss(
          {data:1}
